    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <HelpCircle
            className="h-4 w-4 text-slate-400 pointer-events-auto"
          />
        </TooltipTrigger>
        <TooltipContent side="right">Olá! Estamos ajustando essa aba para tornar ela melhor possível!</TooltipContent>
      </Tooltip>
    </TooltipProvider>
  )}
    </>
