        ...
        <Card className="shadow-sm">
          <CardHeader className="pb-3 flex flex-row items-center gap-2">
            ...
            <div className="space-y-1">
              <CardTitle className="text-base">Configurações do Usuário</CardTitle>
              <CardDescription>Edite as informações do aluno</CardDescription>
            </div>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="focus-visible:ring-primary/30"
                />
                <p className="text-sm text-muted-foreground">Opcional. Exemplo: Turma A, Turma B, etc.</p>
              </div>
              <div className="space-y-2 md:col-span-2">
                ...
                <p className="text-sm text-muted-foreground">Opcional. Selecione a série ou ano do aluno.</p>
              </div>
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea
                  ...
                  className="min-h-[100px] focus-visible:ring-primary/30 resize-y"
                />
          ...
          <CardFooter className="pt-6 flex flex-col md:flex-row justify-end gap-3">
            <Button
              type="button"
              variant="outline"
              asChild
            ...
            <Button 
              ...
              className="w-full md:w-auto min-w-[160px] bg-primary text-white hover:bg-primary/90"
            >
              {isSubmitting ? (
                <>
