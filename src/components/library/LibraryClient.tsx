...
import { Search, BookOpen, User, LogOut, Library, BookMarked, AlertTriangle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-12 relative z-0">
          ...
          <form
            action={`/biblioteca/${params.slug}`}
            method="GET"
            className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-1"
          >
          ...
          <>
            {books.length > 0 ? (
              ...
              >
                ...
                <Button
                  onClick={() => (window.location.href = `/biblioteca/${params.slug}`)}
                  variant="outline"
